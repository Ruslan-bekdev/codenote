...
// Rules:
// {{текст}} для копировани
// !!!!текст!!!! для сырого текста чтобы оставалось также как я написал здесь
// ~~ заменяется на hr тег (полоска)
// Текст: заменяется на ~~Текст:~~. Смысл именно в двоеточем. Чтобы избежать просто пиши пробле после :