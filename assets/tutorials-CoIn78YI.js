...
Питание, "PowerPlay", убрать галочку с "Включить Vari-Bright"`},{summary:"Установка Microsoft Store если его нет (например после моего тутора на винду)",content:"wsreset –i в командную строку"},{summary:"Как починить рассинхрон аудио и видео через ffmpeg",content:`Переходим по ссылке https://ffmpeg.org/download.html#build-windows
